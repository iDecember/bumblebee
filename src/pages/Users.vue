<template>
  <div>
    ...
    <!-- 用户信息dialog添加具体信息 -->
    <el-dialog title="用户信息" :visible.sync="addDialogVisible2" width="50%" @close="addDialogClosed">
      <!-- 内容主体区域 -->
    ...
    <!-- 增加消费记录dialog -->
    <el-dialog title="用户信息" :visible.sync="addDialogVisible4" width="50%" @close="addDialogClosed">
      <!-- 内容主体区域 -->
  ...
  export default {
    ...
    methods: {
      ...
      /*   addDialogClosed() {
            ...
            this.$refs.addConsumeFormRef.resetFields()
          })
